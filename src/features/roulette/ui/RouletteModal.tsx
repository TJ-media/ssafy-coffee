...
// 👇 [주의] 파일 경로가 ../components/RouletteResult 가 맞는지 꼭 확인하세요!
// (src/features/roulette/ui 에 이 파일이 있고, src/features/roulette/components 에 RouletteResult가 있어야 함)
...
// 👇 기존 로직들 import (경로가 ../components/roulette 라면)
import { Roulette } from '../components/roulette';

// ... (나머지 코드는 이전 답변의 RouletteModal.tsx와 동일합니다. 아래는 생략된 부분을 포함한 전체 코드입니다.)
                ...
                <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
                    <div className="bg-gray-900 rounded-2xl shadow-2xl max-w-lg w-full p-6 border border-gray-700 pinball-modal-enter max-h-[90vh] overflow-y-auto custom-scrollbar">
                        <RouletteResult
                            ...
                            onReset={onClose} // 👇 onClose가 handleCloseRoulette와 연결됨
                            isWinner={isWinner}
