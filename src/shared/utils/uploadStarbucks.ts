...
export const uploadStarbucksData = async () => {
    const starbucksData = {
        ...
        items: [
            ...
            { id: 204, categoryUpper: '커피', categoryLower: '에스프레소', name: '시그니처 코르타도', price: 5800, hotPrice: 5800, img: '☕', hasOption: true, defaultOption: 'HOT', sizes: ['Short', 'Tall', 'Grande', 'Venti'] },
            ...
            { id: 207, categoryUpper: '커피', categoryLower: '아메리카노', name: '카페 아메리카노', price: 4700, hotPrice: 4700, img: '☕', hasOption: true, defaultOption: 'HOT', sizes: ['Short', 'Tall', 'Grande', 'Venti'] },
            ...
            { id: 218, categoryUpper: '커피', categoryLower: '에스프레소', name: '에스프레소', price: 3900, img: '☕', hasOption: false, defaultOption: 'HOT' , sizes: ['Short', 'Tall', 'Grande', 'Venti']},
            { id: 219, categoryUpper: '커피', categoryLower: '에스프레소', name: '에스프레소 마키아또', price: 3900, img: '☕', hasOption: false, defaultOption: 'HOT' , sizes: ['Short', 'Tall', 'Grande', 'Venti']},
            { id: 220, categoryUpper: '커피', categoryLower: '에스프레소', name: '에스프레소 콘 파나', price: 4100, img: '☕', hasOption: false, defaultOption: 'HOT' , sizes: ['Short', 'Tall', 'Grande', 'Venti']},
